...
function Form({login, setLogin, password, setPassword, onClick}:Form.IFormLoginProps){
    return (
        <form className={styles["form-login"]}>
            ...
            <InputForm value={login} setValue={setLogin} placeholder="Логин" title="Логин"/>
            <InputForm value={password} setValue={setPassword} placeholder="Пароль" title="Пароль" type="password"/>
